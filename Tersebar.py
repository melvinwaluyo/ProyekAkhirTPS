...
class Person:
    def __init__(self, x, y, elevators, entry_point):
        ...
        self.target_elevator = self.assign_target_elevator()
        self.waiting = False
    ...
    def assign_target_elevator(self):
        if self.entry_point == 'North1':
            return self.elevators[0]  # Top west elevator
        elif self.entry_point == 'North2':
            return self.elevators[2]  # Top east elevator
        elif self.entry_point == 'South1':
            return self.elevators[1]  # Bottom west elevator
        elif self.entry_point == 'South2':
            return self.elevators[3]  # Bottom east elevator
...
# Create elevators
elevators = [
    Elevator(250, 250),  # Top west elevator
    Elevator(250, 350),  # Bottom west elevator
    Elevator(500, 250),  # Top east elevator
    Elevator(500, 350)   # Bottom east elevator
]
...
while running:
    ...
    # Update people
    all_full = all(elevator.full for elevator in elevators)
    for person in people:
        person.update()
        if all_full and person.waiting:
            # If all elevators are full, make people queue at a certain place
            person.queue()
        elif not all_full:
            # Unfreeze all waiting people when an elevator becomes available
